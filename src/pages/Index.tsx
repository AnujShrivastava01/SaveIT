...
const Index = () => {
  ...
  // Check if we're running without Clerk (for debugging)
...
arr.reduce((sum, x) => sum + x, 0); // 15`,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex flex-col">
      ...
      {/* Show content without authentication if Clerk is not configured */}
      {!isClerkConfigured ? (
        <div className="flex-1">
          <div className="bg-yellow-600/20 border border-yellow-500/50 rounded-lg p-4 m-4">
            <p className="text-yellow-200">
              <strong>Debug Mode:</strong> Running without authentication. Set VITE_CLERK_PUBLISHABLE_KEY to enable Clerk.
            </p>
          </div>
          
          {/* Show the main app content for debugging */}
